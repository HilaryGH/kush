...
const Button = ({ 
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-yellow-400 to-red-500 text-white hover:shadow-lg hover:shadow-yellow-200/50 focus:ring-yellow-500 hover:opacity-90',
    secondary: 'bg-gradient-to-r from-yellow-300 to-yellow-500 text-slate-900 hover:shadow-md hover:shadow-yellow-200/50 focus:ring-yellow-400',
    outline: 'border-2 border-yellow-400 text-yellow-600 hover:bg-yellow-50 focus:ring-yellow-500 hover:border-yellow-500',
