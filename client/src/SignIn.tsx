...
const SignIn = () => {
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-gradient-to-b from-yellow-50 via-white to-yellow-100">
      ...
      <div className="relative z-10 flex flex-1 items-center justify-center px-4 py-24 md:px-6">
        <div className="w-full max-w-md">
          {/* Title */}
          <div className="mb-6 text-center">
            <p className="section-kicker">Member Access</p>
            <h1 className="font-display mt-3 text-3xl text-slate-900 md:text-4xl">
          ...
          {/* Sign In Form */}
          <div className="form-shell p-5 md:p-7">
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-2.5 top-[2.125rem] text-slate-500 hover:text-slate-700 transition-colors p-0.5 rounded-md hover:bg-slate-100 flex items-center justify-center"
            ...
            <div className="flex items-center justify-end -mt-0.5">
              <Link
                to="/forgot-password"
                className="text-[11px] text-yellow-600 hover:text-yellow-700 font-medium transition-colors"
              >
                Forgot password?
              </Link>
            </div>
          ...
          {/* Divider */}
            ...
            <span className="px-2 text-[11px] text-slate-500">Or continue with</span>
            <div className="flex-1 border-t border-yellow-200"></div>
          </div>
